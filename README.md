...
`/home/fse`.  These files can be generated by running the following commands:
...
Note that these commands can take a significant time to run for programs except
for plume-util.  See Table 1 in the paper for the wall-clock time required to
